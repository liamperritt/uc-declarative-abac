...
EXPECTED_PRIVILEGES = {
    ...
    SecurablePrivilege(SecurableType.SCHEMA, "liam_perritt.lff_sqlserver_bronze", Principal(PrincipalType.SERVICE_PRINCIPAL, "sp_uc_governor_test", "sp_uc_governor_test"), PrivilegeType.USE_SCHEMA),
